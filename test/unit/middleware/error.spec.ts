    ...
    describe('When running in the "development" environment', () => {
        ...
        describe('When an "UnauthorizedError" is given', () => {
            ...
            it('should use an unauthorized response', () => {
                expect(fakeResponse.boom.unauthorized).to.have.been.calledWith('fake-message', unauthorizedError);
            });
        ...
        describe('When an "ForbiddenError" is given', () => {
            ...
            it('should use an unauthorized response', () => {
                expect(fakeResponse.boom.forbidden).to.have.been.calledWith('fake-message', forbiddenError);
            });
        ...
        describe('When an "ValidationError" is given', () => {
            ...
            it('should use an bad request response', () => {
                expect(fakeResponse.boom.badRequest).to.have.been.calledWith('fake-message', validationError);
            });
        ...
        describe('When an "ConflictError" is given', () => {
            ...
            it('should use a conflict response', () => {
                expect(fakeResponse.boom.conflict).to.have.been.calledWith('fake-message', conflictError);
            });
        ...
        describe('When an "NotFoundError" is given', () => {
            ...
            it('should use a not found response', () => {
                expect(fakeResponse.boom.notFound).to.have.been.calledWith('fake-message', notFoundError);
            });
